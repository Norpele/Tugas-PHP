...
if (isset($_POST['simpan'])) { //untuk create
    ...
    if ($username && $password && $status) {
        if ($op == 'edit') { //untuk update
            $sql1 = "update admin set username = '$username',password ='$password',status = '$status' where id = '$id'";
            $q1 = mysqli_query($koneksi, $sql1);
            if ($q1) {
            ...
            $sql1 = "insert into admin(username,password,status) values ('$username','$password','$status')";
            $q1 = mysqli_query($koneksi, $sql1);
            if ($q1) {
